...
import it.polito.groupslaveapp.search_group.SearchGroupActivity;

public class MainActivity extends AppCompatActivity {

    private static final String TAG = MainActivity.class.getSimpleName();

    Class intentClass = SearchGroupActivity.class;
   ...
   /* @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetworkAvailable()) {
            Toast.makeText(this, "Nessuna connessione disponibile! ", Toast.LENGTH_SHORT).show();
